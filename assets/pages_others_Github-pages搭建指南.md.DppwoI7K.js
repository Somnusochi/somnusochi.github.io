...
<span class="line"><span style="color:#F8F8F2;">   └─ index.md         # 首页内容</span></span></code></pre></div></div><h2 id="注意事项" tabindex="-1">注意事项 <a class="header-anchor" href="#注意事项" aria-label="Permalink to &quot;注意事项&quot;">​</a></h2><ol><li>确保 Github 仓库开启了 Pages 功能</li><li>配置正确的部署分支和目录</li><li>设置合适的 Github Token 权限</li></ol><h2 id="参考资源" tabindex="-1">参考资源 <a class="header-anchor" href="#参考资源" aria-label="Permalink to &quot;参考资源&quot;">​</a></h2><ul><li><a href="https://vitepress.dev/zh/" target="_blank" rel="noreferrer">VitePress 官方文档</a></li><li><a href="https://docs.github.com/en/pages" target="_blank" rel="noreferrer">Github Pages 文档</a></li></ul>`,22))])}const D=l(c,[["render",F]]);export{E as __pageData,D as default};
