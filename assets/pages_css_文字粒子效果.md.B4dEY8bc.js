...
<span class="line"><span style="color:#F8F8F2;">/&gt;</span></span></code></pre></div></div><h2 id="总结" tabindex="-1">总结 <a class="header-anchor" href="#总结" aria-label="Permalink to &quot;总结&quot;">​</a></h2><p>本文完整实现了从<code>React</code>到<code>Vue3</code>的动画组件迁移，关键技术点包括：</p><ol><li>动画系统转换：<code>framer-motion</code> → <code>motion-v</code></li><li>状态管理： <code>useState</code> → <code>ref</code> + <code>Composition API</code></li><li>生命周期： <code>useEffect</code> → <code>onMounted/onUnmounted</code></li></ol><h2 id="参考资料" tabindex="-1">参考资料 <a class="header-anchor" href="#参考资料" aria-label="Permalink to &quot;参考资料&quot;">​</a></h2><p><a href="https://ui.aceternity.com/components/flip-words" target="_blank" rel="noreferrer">flip-words</a> -A component that flips through a list of words</p><p><a href="https://motion.dev/" target="_blank" rel="noreferrer">Motion</a> -A modern animation library for JavaScript and React</p><p><a href="https://motion.seacoly.me/" target="_blank" rel="noreferrer">Motion Vue</a> -Build beautiful motion-driven interfaces with Vue.js based on motion. Simple, powerful, and performant animations for modern web applications.</p>`,8))])}const A=p(c,[["render",F]]);export{m as __pageData,A as default};
